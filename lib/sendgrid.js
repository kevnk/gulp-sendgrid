 ...
 */
SendGrid.prototype.run = function (html, plainText, templateName, versionName, title, cb) {
    var that = this;
    this.html = html;
    ...
    var promise = new Promise(this.getTemplate.bind(this))
        .then(new Promise(this.createVersion.bind(this)).catch(function (e) {
            that.logErr('gulp-sendgrid-7: ' + that.versionName + ' (' + e + ');');
            cb(e);
        }))
        .then(function () {
            cb(html);
